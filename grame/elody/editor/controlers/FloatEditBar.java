...
public class FloatEditBar extends EditBarControler
{
	// on suppose que les valeurs sont comprises entre 0 et max, 	
	public FloatEditBar (int max, int dir, Color inColor, int cols) {
		super (new BarControler(1, max + 9, dir, inColor), cols);
	}

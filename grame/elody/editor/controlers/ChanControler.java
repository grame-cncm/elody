...
public class ChanControler extends EditControler {
	...
	public ChanControler (Color inColor, Image img, int msg, boolean displayAbs) {
		super (new JamButtonControler(-32,32,0,inColor,img), Define.TextCtrlSize, displayAbs);
		setMessage (msg);
	}
